...
def render_path(args, torso_bcs, render_poses, aud_paras, bc_img, hwfcxy, attention_poses, attention_images,intrinsic,
                chunk, render_kwargs, gt_imgs=None, savedir=None, render_factor=8, lip_rect=None):
    H, W, focal, cx, cy = hwfcxy
    print("render_factor",render_factor)
    if render_factor != 0:
...
def config_parser():
    ...
    parser.add_argument("--N_importance", type=int, default=1,
    ...
    #add some paras
    parser.add_argument("--num_reference_images",   type=int, default=1,
